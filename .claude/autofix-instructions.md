...
- If the issue requires changes across more than 15 files or fundamentally restructures the architecture, report it as too complex — set status to failure with an explanation
